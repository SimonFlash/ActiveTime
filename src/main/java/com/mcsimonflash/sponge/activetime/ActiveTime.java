...
@Plugin(id = "activetime", name = "ActiveTime", version = "1.4.0", dependencies = @Dependency(id = "nucleus", optional = true), authors = "Simon_Flash")
public class ActiveTime {
    ...
    public void onInit(GameInitializationEvent event) {
        instance = this;
        logger.info("+=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=+");
        logger.info("|     ActiveTime -- Version 1.4.0     |");
